...
<script id="timelineTemplate" type="text/x-jquery-tmpl">
  <li class="stream-body">
    ...
    <div class="stream-right">
      ...
      <div class="stream-util"><span class="small"><a href="#" data-activity-id="${id}" data-activity-memberScreenName="${memberScreenName}" data-activity-csrftoken="<?php echo $token; ?>" rel="prettyPopin" class="timelineReplyLink">コメントする</a> | <span id="timeline-delete-link-${id}" style="display: ${deleteLink};"><a data-activity-id="${id}" data-activity-body="${convertTag(body)}" data-activity-memberScreenName="${memberScreenName}" data-activity-csrftoken="<?php echo $token; ?>" rel="timelineDelete" href="#" id="delete-timeline">削除する</a></span> (${createdAt})</span></div>
...
<script id="timelineCommentTemplate" type="text/x-jquery-tmpl">
  <li class="stream-comment-body">
    ...
    <div class="stream-text">{{html body}}
      <div class="stream-util"><span class="small"><span id="timeline-delete-link-${id}" style="display: ${deleteLink};"><a rel="timelineDelete" href="#" data-activity-id="${id}" data-activity-body="${convertTag(body)}" data-activity-memberScreenName="${memberScreenName}" data-activity-csrftoken="<?php echo $token; ?>" id="detete-timeline">削除する</a></span> (${createdAt})</span></div>
    </div>
  </li>
</script>
