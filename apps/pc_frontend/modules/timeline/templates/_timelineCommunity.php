...
<div class="partsHeading"><h3>コミュニティのアクティビティ</h3></div>
...
<script type="text/javascript" src="<?php echo $baseUrl; ?>/timeline/js?mode=2&cid=<?php echo $cid; ?>"></script>
...
<script id="timelineTemplate" type="text/x-jquery-tmpl">
  <li class="stream-body">
    ...
    <div class="stream-right">
      ...
      <div class="stream-util"><span class="small"><a href="#" data-activity-id="${id}" data-activity-memberScreenName="${memberScreenName}" data-activity-foreign-id="<?php echo $cid; ?>" data-activity-foreign="community" rel="prettyPopin" class="timelineReplyLink">コメントする</a> | <span id="timeline-delete-link-${id}" style="display: ${deleteLink};"><a data-activity-id="${id}" data-activity-body="${convertTag(body)}" data-activity-memberScreenName="${memberScreenName}" rel="timelineDelete" href="#" id="delete-timeline">削除する</a></span> (${createdAt})</span></div>
...
<div id="timeline-community-container">
<div id="timeline-community-post">
  <div id="timeline-community-textbox"><textarea rows="8" cols="30" name="timeline-textarea" id="timeline-textarea"></textarea><input type="hidden" name="csrf" id="timeline-csrf" value="" /></div>
  <div id="timeline-communtiy-submit"><button id="timeline-button">投稿する</button></div>
</div>
  <ul id="streamList">
  </ul>
</div>
